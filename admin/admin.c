...
void AddStudentRecord(Student *ps) {
    while (1) {
        ...
        int choice = 0;
        scanf("%d", &choice);
        if (choice != 0) choice = 1; // any non zero number will result in adding more students.
        if (!choice) break;
    }
}
...
void ViewStudentRecord(Student *ps) {
    while (1) {
        ...
        int choice = 0;
        scanf("%d", &choice);
        if (choice != 0) choice = 1; // any non zero number will result in viewing more students.
        if (!choice) break;
    }
}
